...
; GFX950-NEXT:    s_mov_b32 s2, 0x7fffff
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    s_mov_b32 s2, 0x7fffff
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX90A-NEXT:    s_endpgm
  %dividend = and i32 %input, 8388607
  %divisor = or i32 %dividend, 1
  %result = udiv i32 %dividend, %divisor
  store i32 %result, ptr addrspace(1) %out, align 4
  ret void
...
define amdgpu_kernel void @udiv_i32_u23_divbits_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: udiv_i32_u23_divbits_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_and_b32 s3, s3, s2
; GFX950-NEXT:    s_mov_b32 s4, 0x400000
; GFX950-NEXT:    s_or_b32 s5, s3, s4
; GFX950-NEXT:    s_mov_b32 s3, 1
; GFX950-NEXT:    s_or_b32 s4, s5, s3
; GFX950-NEXT:    v_cvt_f32_u32_e64 v2, s5
; GFX950-NEXT:    v_cvt_f32_u32_e64 v3, s4
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: udiv_i32_u23_divbits_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_and_b32 s3, s3, s2
; GFX90A-NEXT:    s_mov_b32 s4, 0x400000
; GFX90A-NEXT:    s_or_b32 s5, s3, s4
; GFX90A-NEXT:    s_mov_b32 s3, 1
; GFX90A-NEXT:    s_or_b32 s4, s5, s3
; GFX90A-NEXT:    v_cvt_f32_u32_e64 v2, s5
; GFX90A-NEXT:    v_cvt_f32_u32_e64 v3, s4
...
; GFX90A-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX90A-NEXT:    s_endpgm
  %masked = and i32 %input, 8388607
  %dividend = or i32 %masked, 4194304
  %divisor = or i32 %dividend, 1
  %result = udiv i32 %dividend, %divisor
  store i32 %result, ptr addrspace(1) %out, align 4
  ret void
...
define amdgpu_kernel void @urem_i32_u23_divbits_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: urem_i32_u23_divbits_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: urem_i32_u23_divbits_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
define amdgpu_kernel void @udiv_i32_u24_divbits_no_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: udiv_i32_u24_divbits_no_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_mov_b32 s3, 0x800000
; GFX950-NEXT:    s_or_b32 s4, s2, s3
; GFX950-NEXT:    s_mov_b32 s2, 1
; GFX950-NEXT:    s_or_b32 s5, s4, s2
; GFX950-NEXT:    s_mov_b32 s3, 0
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: udiv_i32_u24_divbits_no_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX90A-NEXT:    s_mov_b32 s3, 0x800000
; GFX90A-NEXT:    s_or_b32 s4, s2, s3
; GFX90A-NEXT:    s_mov_b32 s2, 1
; GFX90A-NEXT:    s_or_b32 s5, s4, s2
; GFX90A-NEXT:    s_mov_b32 s3, 0
...
; GFX90A-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX90A-NEXT:    s_endpgm
  %masked = and i32 %input, 16777215
  %dividend = or i32 %masked, 8388608
  %divisor = or i32 %dividend, 1
  %result = udiv i32 %dividend, %divisor
  store i32 %result, ptr addrspace(1) %out, align 4
  ret void
...
define amdgpu_kernel void @urem_i32_u24_divbits_no_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: urem_i32_u24_divbits_no_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: urem_i32_u24_divbits_no_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
